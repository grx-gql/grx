...
func TestWebSocketTransportGraphQLWebSocketSession(t *testing.T) {
...
func TestWebSocketTransportGraphQLWebSocketProtocolErrors(t *testing.T) {
	cases := []struct {
		name    string
		config  Config
		frames  []string
...
func TestWebSocketTransportServerPingAndHelpers(t *testing.T) {
	executor := &wsCoverExecutor{stream: make(chan core.Response, 1)}
...
func TestWebSocketTransportHandshakeCloseBranches(t *testing.T) {
...
func TestWebSocketTransportConnectionInitDeadlineClosesHandshake(t *testing.T) {
	executor := &wsCoverExecutor{stream: make(chan core.Response, 1)}
...
func TestWebSocketTransportSkipsNonTextFramesUntilPing(t *testing.T) {
	executor := &wsCoverExecutor{stream: make(chan core.Response, 1)}
	tr := New()
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		tr.Serve(w, r, executor)
...
func TestWebSocketTransportAcceptsClientPongBeforeHeartbeat(t *testing.T) {
	executor := &wsCoverExecutor{stream: make(chan core.Response, 1)}
	tr := New()
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		tr.Serve(w, r, executor)
...
func TestWebSocketTransportDuplicateSubscriptionIDClosesConnection(t *testing.T) {
...
func TestWebSocketTransportSubscribePropagatesSubscribeError(t *testing.T) {
	stream := make(chan core.Response)
...
func TestWebSocketTransportRejectSubscriptionPastMaxActive(t *testing.T) {
...
func TestWebSocketTransportAckWithoutOptionalPayloadBody(t *testing.T) {
...
func TestWebSocketTransportMaxConnectionsLimit(t *testing.T) {
	tr := &WebSocketTransport{config: Config{MaxConnections: 1}}
	c1, c2 := &Conn{}, &Conn{}
...
func TestWebSocketTransportShutdownDrainsWithGoingAway(t *testing.T) {
