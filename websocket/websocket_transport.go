...
// Config configures a WebSocketTransport. All fields are optional; zero values
...
// WebSocketTransport implements core.Transport for the graphql-transport-ws
...
func (t *WebSocketTransport) register(c *Conn) bool {
	t.mu.Lock()
	defer t.mu.Unlock()
	if t.draining {
		return false
...
func (t *WebSocketTransport) unregister(c *Conn) {
	t.mu.Lock()
...
func (*WebSocketTransport) Match(r *http.Request) bool { return IsUpgrade(r) }
