...
| --- | --- |
| `github.com/patrickkabwe/grx` | Code-first resolvers (`Execute` only) |
...
Published doc tables (means, **2026-05-21**, M1 Pro / Go 1.25, `-benchtime=2s -count=3`): **[Benchmarks](https://patrickkabwe.github.io/grx/benchmarks.html)** / [`docs/benchmarks.md`](/docs/benchmarks.md).
