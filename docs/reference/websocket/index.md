---
title: websocket
description: API reference for the websocket package, generated from Go doc comments.
outline: [2, 4]
lastUpdated: false
---
...
- [type WebSocketTransport](<#WebSocketTransport>)
  - [func New\(cfg ...Config\) \*WebSocketTransport](<#New>)
  - [func \(\*WebSocketTransport\) Match\(r \*http.Request\) bool](<#WebSocketTransport.Match>)
  - [func \(t \*WebSocketTransport\) Serve\(w http.ResponseWriter, r \*http.Request, executor core.Executor\)](<#WebSocketTransport.Serve>)
...
Config tunes WebSocketTransport. All fields are optional; zero values fall back to safe production defaults documented per field.
...
WebSocketTransport implements core.Transport for the graphql\-transport\-ws subprotocol. Construct with New; the zero value also works and applies all defaults.
...
New returns a WebSocketTransport ready to be registered with the server.

<a name="WebSocketTransport.Match"></a>
### func \(\*WebSocketTransport\) Match

```go
func (*WebSocketTransport) Match(r *http.Request) bool
```

Match reports whether r is a WebSocket upgrade request.

<a name="WebSocketTransport.Serve"></a>
### func \(\*WebSocketTransport\) Serve

```go
func (t *WebSocketTransport) Serve(w http.ResponseWriter, r *http.Request, executor core.Executor)
```
